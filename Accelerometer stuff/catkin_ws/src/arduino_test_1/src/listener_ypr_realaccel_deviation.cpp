...
xaccel[accelindex]=(initialData[0]-(*msg).data[3])/10.0/16384.0;
yaccel[accelindex]=(initialData[1]-(*msg).data[4])/10.0/16384.0;
zaccel[accelindex]=(initialData[2]-(*msg).data[5])/10.0/16384.0;
...
printf("ypr deviation: %8.3f %8.3f %8.3f   xyzaccel deviation: %9.6f %9.6f %9.6f  %.0f \n", (initialData[3]-(*msg).data[3]), (initialData[4]-(*msg).data[4]), (initialData[5]-(*msg).data[5]), (initialData[0]-(*msg).data[0])/16384.0, (initialData[1]-(*msg).data[1])/16384.0, (initialData[2]-(*msg).data[2])/16384.0, difftime(time(NULL),starttime));
